...
//         const avilableItems = cart.find((cartItem) => cartItem.id === item.id);
//         if(avilableItems){
...
//             setCart(updateCart);
//         }else{
//             const updateCart = [...cart, {...item, quantity: 1, amount: item.price}]
//             setCart(updateCart)
//         }
//     }

//     const dicreezQunt = (item) => {
//         const avilableItems = cart.find((cartItem) => cartItem.id === item.id);
//         if(avilableItems){
//         const updateCart2 = cart.map((cartItem) => {
//             if(cartItem.id === item.id){
//                 return{
//                     ...cartItem,
//                     quantity: cartItem.quantity - 1,
...
//                                                     dicreezQunt(item)
//                                                 }
//                                             }}>-</button> {item.quantity} <button onClick={() => increementQunt(item)}>+</button></h5>
...
//                             <h3>Subtotal <span className="ODI">({totalItems} items)</span>:   ₹<span className="amount">{totalAmount}.00</span></h3>
